...
# save outputs
psa_save <- paste("outputs/prob_medsurv_observed_", switch_observed, 
                  "_test_", switch_test,".rds", sep = "")
save(l_outcomes_PSA, file = psa_save)
...
# Frontier
save_name_frontier <- paste("outputs/frontier_PSA_observed_", switch_observed, 
                            "_test_", switch_test,".csv", sep = "")
df_frontier_PSA <- PSA_frontier(v_tumour, l_outcomes_PSA, save_name_frontier)
